...
namespace WebStone\Redkit\Pipe;

use WebStone\Redkit\Param;
use WebStone\Redkit\Response;
...
trait SortedTrait
{
    ...
    public function zrange($key, $start, $stop, $withscores = false)
    {
        ...
        return $this->returnCommand(['ZRANGE'], $params, $withscores ? Response::PARSE_ASSOC_ARRAY : null);
    }
    ...
    public function zrangebyscore($key, $min, $max, $withscores = false, $limit = null)
    {
        ...
        return $this->returnCommand(['ZRANGEBYSCORE'], $params, $withscores ? Response::PARSE_ASSOC_ARRAY : null);
    }
    ...
    public function zrevrange($key, $start, $stop, $withscores = false)
    {
        ...
        return $this->returnCommand(['ZREVRANGE'], $params, $withscores ? Response::PARSE_ASSOC_ARRAY : null);
    }
    ...
    public function zrevrangebyscore($key, $max, $min, $withscores = false, $limit = null)
    {
        ...
        return $this->returnCommand(['ZREVRANGEBYSCORE'], $params, $withscores ? Response::PARSE_ASSOC_ARRAY : null);
    }
