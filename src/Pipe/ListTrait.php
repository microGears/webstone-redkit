...
trait ListTrait
{
    ...
    {
        return $this->returnCommand( ['BLPOP'], [(array)$keys, $timeout], Response::PARSE_ASSOC_ARRAY );
    }
    ...
    {
        return $this->returnCommand( ['BRPOP'], [(array)$keys, $timeout], Response::PARSE_ASSOC_ARRAY );
    }
