...
trait ServerTrait
{
    ...
    {
        return $this->returnCommand( ['CLIENT', 'LIST'], null, Response::PARSE_CLIENT_LIST );
    }
    ...
    {
        return $this->returnCommand( ['CONFIG', 'GET'], [$parameter], Response::PARSE_ASSOC_ARRAY );
    }
    ...
    {
        return $this->returnCommand( ['INFO'], $section ? [$section] : null, Response::PARSE_INFO );
    }
    ...
    {
        return $this->returnCommand( ['TIME'], null, Response::PARSE_TIME );
    }
}